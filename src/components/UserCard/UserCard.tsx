...
const UserCard = ({username, company, id}: Card) => {
    ...
    return (
        <div onClick={() => handleClick(id)}  className={cn(style.cardContainer, {[style.selectedFont] : isSelected })}>
            <div className={style.imageContainer}>
            <img src={`https://i.pravatar.cc/290?img=${id}`} alt="avatar" loading="lazy" className={cn(style.image, {[style.selected] : isSelected} )}/> 
            </div>
